...

{
  ...
  "total_fixed_costs": "年間固定費総額：売上・稼働率に関わらず発生する費用の合計。製造原価の固定費（労務費・減価償却費・リース料・保険料等）＋販管費の固定費（役員報酬・給与・賞与・福利厚生・広告費・地代家賃・租税公課・減価償却費・保険料・通勤費・諸会費等）＋営業外費用（支払利息）を合算。材料費・外注費・荷造発送費・水道光熱費・支払手数料・消耗品費などの変動費は除く。見つからない場合は0",
  "marginal_profit": "限界利益（付加価値）：売上高から変動費（材料費・外注費・荷造発送費・水道光熱費・支払手数料等の変動的費用）を差し引いた金額。決算書に明示がない場合は固定費合計＋営業利益で近似。見つからない場合は0",
