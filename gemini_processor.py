...

{
  ...
  "labor_cost": "人件費総額：工場側（製造原価の労務費合計）＋本社営業側（販管費の役員報酬・給与・賞与・法定福利費・通勤費の合計）を合算した全社の人件費。見つからない場合は0",
  "current_assets": "貸借対照表 流動資産合計",
  "current_liabilities": "貸借対照表 流動負債合計",
  "inventory": "貸借対照表 棚卸資産合計（製品・仕掛品・原材料・商品などの合計。見つからない場合は0）",
  "total_fixed_costs": "年間固定費総額（管理会計区分）：製造原価（材料費・労務費・製造経費のうち固定分）＋販管費の固定項目（役員報酬・給与・賞与・法定福利費・広告費・地代家賃・租税公課・減価償却費・保険料・通勤費・諸会費等）の合計。荷造発送費・外注加工費・水道光熱費・支払手数料・販売員旅費・消耗品費・販売促進費などの変動費は除く。見つからない場合は0",
  "marginal_profit": "限界利益：売上高から変動費合計（荷造発送費・外注加工費・水道光熱費・支払手数料・交際費・販売員旅費・消耗品費・販売促進費等）を差し引いた金額。見つからない場合は売上高から変動費を引いて計算。0の場合は0",
  "cash_deposits": "貸借対照表の現金・預金合計（当座預金・普通預金・定期預金等）",
  "interest_bearing_debt": "有利子負債合計：短期借入金＋長期借入金＋役員借入金＋社債等の金融機関からの借入総額",
  "depreciation": "当期の減価償却費合計：製造原価の減価償却費＋販売費及び一般管理費の減価償却費の合計",
